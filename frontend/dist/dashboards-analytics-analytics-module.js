...
var AnalyticsDashboardComponent = /** @class */ (function () {
    ...
    AnalyticsDashboardComponent.prototype.ngOnInit = function () {
        ...
        this.revenu = [];
        this.revenuMax = 0;
        this.year = moment__WEBPACK_IMPORTED_MODULE_4__(new Date()).format('YYYY');
        // Get the widgets from the service
        this.widgets = this._analyticsDashboardService.widgets;
        this._analyticsDashboardService.getStats().subscribe(function (result) {
            _this.stats = result;
        });
        this._analyticsDashboardService.getTotalRevenu(this.year)
            ...
            for (var _i = 0; _i < 13; _i++) {
                if (_this.revenu[_i] === null) {
                    _this.revenu[_i] = 0;
                }
                if (_this.revenu[_i] > _this.revenuMax) {
                    _this.revenuMax = _this.revenu[_i];
                }
            }
            _this.revenuChart = {
                widget1: {
                        ...
                        '2019': [
                            {
                                ...
                                data: [_this.revenu[1] / 1000,
                                    ...
                                    _this.revenu[8] / 1000,
                                    _this.revenu[9] / 1000,
                                    _this.revenu[10] / 1000,
                                    _this.revenu[11] / 1000,
                                    _this.revenu[12] / 1000,
                                ],
                                fill: 'start'
                            }
                        ]
...
var AnalyticsDashboardService = /** @class */ (function () {
    ...
    AnalyticsDashboardService.prototype.getStats = function () {
        var pro = {};
        return this._httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + 'stats/backOffice', pro);
    };
    AnalyticsDashboardService.prototype.getTotalRevenu = function (year) {
        var revenu = {
            year: String
        };
        revenu.year = year;
        return this._httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + 'stats/revenu', revenu);
    };
